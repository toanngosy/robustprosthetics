#Soft Actor-Critic from Stable baselines (https://github.com/hill-a/stable-baselines) 
#with a few modifications to fit the environnement
# - force observations to numpy array
# - frameskip (repeat the same action 4 times)
# - scaling of the action vector to be between 0 and 1
            ...
            for step in range(total_timesteps):
                ...
                if self.num_timesteps < self.learning_starts:
                    ...
                    if i<3:
                        ...
                        target = scale_range(action, -1, 1, 0, 1)
                        #target = scale_discrete(action)
                        i = 0


                assert action.shape == self.env.action_space.shape
                new_obs, reward, done, info = self.env.step(target)
