...
def detect_multiparam(args, data):
    ...
    # A ce stade, si args.grid == True, c'est qu'il y a des paramètres avec plusieurs valeurs à tester
    # A ce stade, si args.grid == False, c'est que tous les paramètres n'ont qu'une seule valeur
